...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // create new edge
                            //TODO 4 make edge unique
                            std::unique_ptr<GraphEdge> edge(new GraphEdge(id));
                            // TODO 3 use get is not optimal here but required with unique pointer. 
    ...
    for (auto it = std::begin(_nodes); it != std::end(_nodes); ++it)
    {
        ...
        if ((*it)->GetNumberOfParents() == 0)
        {
            ...
            if (rootNode == nullptr)
            {
                //TODO 3 using get to access node address
    ...
    //TODO 5 create chatbot on stack and move to root nodes
